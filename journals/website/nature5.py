...
class journals(common_journals):
    ...
    def get(self,website,journal,url):
        ...
        wait()
        for i in range(7):
            url1="https://www.nature.com/cgt/volumes/"+str(i+18)
            ...
            for li in ul.find_all("li"):
                ...
                if a != None:
                    if a.find("h3") != None:
                        ...
                        article_info[Row_Name.VOLUME] = str(i+18)
                        article_info[Row_Name.YEAR] = str(i+2011)
    ...
    def get_common(self,journal,url):
        return {Row_Name.ISSN:"0929-1903",Row_Name.EISSN:"1476-5500"}
